...
% output
    ...
    MacroF1Measure=MacroF1(Pre_Labels, test_target);
    MicroF1Measure=MicroF1(Pre_Labels, test_target);
    auc=avgauc(Pre_Labels,test_target);
    ...
    ResultAll(6,1)=MicroF1Measure;
    ResultAll(7,1)=MacroF1Measure;
    ResultAll(8,1)=auc;
